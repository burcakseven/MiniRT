...
/**
 * reduce colour according to relation between light source and interception
 * point
 */
...
//    ray_v =
//    make_ray((point3){0,-scene.camera.viewport_height,1},(point3){0,scene.camera.viewport_height,1});
//    ray_h =
//    make_ray((point3){-scene.camera.viewport_width,0,1},(point3){scene.camera.viewport_width,0,1});
...
#ifdef TEST
#include <stdio.h>
int main() { printf("DO NOT TEST ME!!\n") }
#endif
